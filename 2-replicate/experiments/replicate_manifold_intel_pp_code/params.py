...
class Params():
    def __init__(self):
        ...
        parser.add_argument('--img_dir', type=str, default= PROJECT_ROOT + 'data/Celeba_image/')
        parser.add_argument('--input_trace_dir', type=str, default= PROJECT_ROOT + 'data/')
        parser.add_argument('--input_trace_name', type=str, default='manifold_l1dpp_cacheline/')
        parser.add_argument('--ID_PATH', type=str, default= PROJECT_ROOT + 'data/CelebA_ID_dict.json')
        parser.add_argument('--output_root', type=str, default= PROJECT_ROOT + 'output/')
        parser.add_argument('--pretrain_path', type=str, default= PROJECT_ROOT + 'output/')
