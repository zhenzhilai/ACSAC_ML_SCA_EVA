...
wandb.init(
    ...
    name="Replicate Manifold-SCA, Practical cache-line activities, real-aegan",

    mode="disabled",

    save_code=True,

    notes="Replicate Manifold-SCA with the same dataset: AVX idct, 6 x 256 x 256; LR to 2e-4, practical data"
)
...
if __name__ == '__main__':
    ...
    args.trace_c = 1 ###### For Intel PIN, it is 6; for practical, it is 2
    args.trace_w = 256
    args.nz = 128
