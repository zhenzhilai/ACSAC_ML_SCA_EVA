...
Download pre-trained models 'practical_pp_pretrain.tar' and data 'Celeba_image.tar', 'practical_pp_data.tar', 'target_activities_data.tar', 'reconstructed_activities_data.tar' by unzip 'artifact_data.tar' from [ZENODO](https://zenodo.org/records/13937963). Extract it to corresponding directory.
```bash
mkdir model
