...
def load_checkpoint(model, checkpoint_path, epoch):
        checkpoint_path = os.path.join(checkpoint_path, str(epoch)+'.pth')
...
def load_checkpoint_for_test(model, checkpoint_path):
        print("=> loading checkpoint '{}'".format(checkpoint_path))
